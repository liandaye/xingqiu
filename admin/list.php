  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        ...
        <li>
          <input type="text" placeholder="请输入搜索关键字" name="keywords" id="suggest_input" autocomplete="off" class="input" style="width:250px; line-height:17px;display:inline-block" />
         <input type="submit" value="搜索一下" id="suggest_submit" /></li>
      </ul>
      <ul id="suggest_ul">
	</ul>
    </div>
...
<tr>
 ...
 $result=mysql_query('select * from tb_admin');
